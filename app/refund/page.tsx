    ...
    <div className="container mx-auto p-4 max-w-4xl">
      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <h3 className="text-xl font-medium mb-3 mt-4 text-zinc-100">2.1. Способ доставки</h3>
          <p className="text-zinc-300">
          ...
          <h3 className="text-xl font-medium mb-3 mt-4 text-zinc-100">2.2. Время доставки</h3>
          <p className="text-zinc-300">
          ...
          <h3 className="text-xl font-medium mb-3 mt-4 text-zinc-100">2.3. Что происходит при неудачной доставке</h3>
          <p className="text-zinc-300">
            В случае невозможности доставить цифровой товар:
          </p>
          <ol className="list-decimal list-inside space-y-2 ml-4 text-zinc-300">
        ...
        <Card>
          <h2 className="text-2xl font-medium mb-4 text-zinc-100">3. Возврат денежных средств</h2>
          
          <h3 className="text-xl font-medium mb-3 mt-4 text-zinc-100">3.1. Условия возврата</h3>
          <p className="text-zinc-300">
          ...
          <h3 className="text-xl font-medium mb-3 mt-4 text-zinc-100">3.2. Случаи, когда возврат невозможен</h3>
          <p className="text-zinc-300">
          ...
          <h3 className="text-xl font-medium mb-3 mt-4 text-zinc-100">3.3. Порядок возврата</h3>
          <ol className="list-decimal list-inside space-y-2 ml-4 text-zinc-300">
          ...
          <h3 className="text-xl font-medium mb-3 mt-4 text-zinc-100">3.4. Сроки возврата</h3>
          <p className="text-zinc-300">
        ...
        <Card>
          <h2 className="text-2xl font-medium mb-4 text-zinc-100">4. Контакты для возврата</h2>
          <p className="text-zinc-300">
